...
grid on
%xlim([0 Tsimu])
title("Compara��o Entre o Controle LQR e Proporcional")
grid on;
ylabel('Controle');
xlabel('Tempo (s)');
legend('Proporcional','LQR')
...
hold off
xlim([0 Tsimu])
title("Respota a Degrau e Estabiliza��o Controle Proporcional")
grid on;
ylabel('Saida (Pa)');
xlabel('Tempo (s)');
